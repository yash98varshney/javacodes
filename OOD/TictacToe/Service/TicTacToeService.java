package OOD.TictacToe.Service;

import java.util.LinkedList;
import java.util.Queue;

import OOD.TictacToe.Repository.TicTacToeDao;
import OOD.TictacToe.entities.Board;
import OOD.TictacToe.entities.Piece;
import OOD.TictacToe.entities.PieceO;
import OOD.TictacToe.entities.PieceType;
import OOD.TictacToe.entities.PieceX;
import OOD.TictacToe.entities.Player;

public class TicTacToeService {
    
    private final TicTacToeDao ticTacToeDao;
    private final Queue<Player> playerQueue;  //player will be added to this queue when we run addplayer method
